...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    ...
    window.location.assign("<?php echo $Location; ?>/live/?Action=populategroups");
    }
    }
...
<input class="textbox" id="password" type="password" placeholder="Password" style="width:250px; font-size:14px; padding:5px;margin-bottom:2px;"><br/>
...
<h1>Random Name Generator installation complete!</h1>
